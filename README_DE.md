...
2. Lade die neueste Version des Add-ons als ZIP-Datei herunter (z. B. `reply-with-attachments.zip`).
...
5. Wähle die heruntergeladene Datei `reply-with-attachments.zip` aus.
