...
(self.webpackChunkrwa_docs = self.webpackChunkrwa_docs || []).push([
  [330],
  {
    ...
    9356: (e, n, t) => {
      ...
      const r = JSON.parse(
        '{"id":"privacy","title":"Privacy","description":"Reply with Attachments does not collect analytics or telemetry and does not send your data anywhere.","source":"@site/docs/privacy.md","sourceDirName":".","slug":"/privacy","permalink":"/Thunderbird-Reply-with-Attachments/docs/privacy","draft":false,"unlisted":false,"tags":[],"version":"current","lastUpdatedAt":1757116079000,"frontMatter":{"id":"privacy","title":"Privacy","sidebar_label":"Privacy"},"sidebar":"docs","previous":{"title":"Support","permalink":"/Thunderbird-Reply-with-Attachments/docs/support"},"next":{"title":"Donate","permalink":"/Thunderbird-Reply-with-Attachments/docs/donation"}}'
      );
      var o = t(4848),
        i = t(8453);
      const s = { id: 'privacy', title: 'Privacy', sidebar_label: 'Privacy' },
        a = void 0,
        c = {},
        d = [
      ...
      function l(e) {
        ...
        return (0, o.jsxs)(o.Fragment, {
          children: [
            ...
            '\n',
            (0, o.jsx)(n.p, { children: 'What the addon does:' }),
            '\n',
            (0, o.jsxs)(n.ul, {
              children: [
                '\n',
            ...
            '\n',
            (0, o.jsx)(n.p, { children: 'What the addon does not do:' }),
            '\n',
            (0, o.jsxs)(n.ul, {
              children: [
                '\n',
                (0, o.jsx)(n.li, {
                  children: 'No tracking, analytics, crash reporting, or remote logging.',
                }),
                '\n',
                (0, o.jsx)(n.li, {
                  children:
            ...
            (0, o.jsxs)(n.p, {
              children: [
                'Permissions are documented on the ',
                (0, o.jsx)(n.a, { href: 'permissions', children: 'Permissions' }),
                ' page.',
              ],
            }),
            '\n',
            ...
            '\n',
            (0, o.jsx)(n.h2, { id: 'data-storage', children: 'Data storage' }),
            '\n',
            (0, o.jsxs)(n.ul, {
              children: [
                '\n',
                (0, o.jsxs)(n.li, {
                  children: [
                    'User preferences (blacklist, confirmation toggle, default answer) are stored in Thunderbird\u2019s ',
                    (0, o.jsx)(n.code, { children: 'storage.local' }),
                    ' for this addon.',
                  ],
                }),
                '\n',
                (0, o.jsx)(n.li, { children: 'No cloud sync is performed by the addon.' }),
                '\n',
              ],
            }),
            '\n',
            ...
            (0, o.jsxs)(n.ul, {
              children: [
                '\n',
                (0, o.jsx)(n.li, {
                  children: 'The addon performs no background network activity.',
                }),
                '\n',
                (0, o.jsx)(n.li, {
                  children:
