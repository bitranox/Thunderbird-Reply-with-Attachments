...
- د فایل نوم پر بنسټ نقلونه لرې شوي دي؛ د S/MIME برخې تل پریږدل کیږي. هغه انځورونه چې په اصلي پیغام کې ځای پر ځای شوي دي، د ځواب په متن کې پاتې کیږي، هلته چې Thunderbird یې ږدي، او د فایل په توګه نه کاپي کیږي.
...
- ځواب وپیژنئ → اصلي ضمیمې لیست کړئ → S/MIME او ننوتلي انځورونه پریږدئ → اختیاري تایید → وړ فایلونه اضافه کړئ (د تکراري توکو پریښودلو سره).

| د برخې ډول                                                    | ځواب ته کاپي کیږي    |
|---------------------------------------------------------------|---------------------:|
| د S/MIME لاسلیک فایل `smime.p7s`                              | نه                   |
| د S/MIME MIME ډولونه (`application/pkcs7-*`)                  | نه                   |
| هغه انځور چې د پیغام متن یې د `cid:` له لارې ځای پر ځای کوي   | نه (دا په متن کې دی) |
| هغه انځور چې د `Content-Disposition: inline` په توګه نښه شوی  | نه (دا په متن کې دی) |
| هغه انځور چې `Content-ID` لري خو متن هیڅکله ورته اشاره نه کوي | هو                   |
| هغه ضمیمه شوی بریښنالیک (`message/rfc822`) چې د فایل نوم لري  | هو                   |
| هغه عادي فایل ضمیمه چې د فایل نوم لري                         | هو                   |

یو انځور یوازې هغه وخت ځای پر ځای شوی شمېرل کیږي کله چې اصلي پیغام په رښتیا ورته اشاره وکړي، یا کله چې لیږونکي
په ښکاره ډول دا `Content-Disposition: inline` په توګه نښه کړی وي. یوازینی `Content-ID` سرلیک بس نه دی: ډیری میل کلاینټونه
دا په هر انځور برخه کې ږدي، پشمول د رښتینو ضمیمو، او هغه بیا هم باید کاپي شي.
...
- هغه انځورونه چې اصلي پیغام ننوځوي، د فایلونو په توګه نه کاپي کیږي. دوی مخکې له مخکې د ځواب په متن کې دي، هلته چې Thunderbird دوی ایښي دي. وګورئ [Configuration](configuration#include-inline-pictures).
