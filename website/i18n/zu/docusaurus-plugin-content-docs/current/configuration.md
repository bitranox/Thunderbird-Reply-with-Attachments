...
## Vula izinketho ku-Thunderbird {#open-options-in-thunderbird}
...
#### I-Blacklist (i-patterns ze-glob) {#blacklist-glob-patterns}
...
##### I-Cookbook ye-pattern {#pattern-cookbook}
...
#### Ukuxwayisa kweziqhumiso ezikhejiwe {#warning-on-excluded-attachments}
...
#### Gcina izilungiselelo zakho {#save-your-settings}
...
#### Ukubukeka Kokubhaliswa (90‑day snooze) {#donation-visibility}
...
### Ukulawulwa kwegama lefayela (ukuvimbela ama-duplicates) {#filename-normalization-duplicates-prevention}
...
## Ukuqinisekiswa kokuphendula {#confirmation-behavior}
...
## Okuthuthukisiwe: ukuvimbela ama-duplicates {#advanced-duplicate-detection}
