...
- ຖືກລຶບຊໍ້າຕາມຊື່ໄຟລ໌; ສ່ວນ S/MIME ຈະຖືກຂ້າມສະເໝີ. ຮູບພາບທີ່ຝັງຢູ່ໃນຂໍ້ຄວາມຕົ້ນສະບັບຍັງຄົງຢູ່ໃນເນື້ອໃນຂອງການຕອບກັບ ບ່ອນທີ່ Thunderbird ວາງມັນໄວ້ ແລະ ຈະບໍ່ຖືກສຳເນົາເປັນໄຟລ໌.
...
- ກວດຫາການຕອບກັບ → ລາຍການໄຟລ໌ແນບຕົ້ນສະບັບ → ຂ້າມ S/MIME ແລະ ຮູບພາບທີ່ຝັງໄວ້ → ການຢືນຢັນທີ່ບໍ່ບັງຄັບ → ເພີ່ມໄຟລ໌ທີ່ມີສິດ (ຂ້າມສຳເນົາຊ້ຳ).

| ປະເພດຂອງສ່ວນ                                          | ຄັດລອກໄປໃສ່ການຕອບກັບ  |
|-------------------------------------------------------|----------------------:|
| ໄຟລ໌ລາຍເຊັນ S/MIME `smime.p7s`                        | ບໍ່                   |
| ປະເພດ MIME ຂອງ S/MIME (`application/pkcs7-*`)         | ບໍ່                   |
| ຮູບພາບທີ່ເນື້ອໃນຂໍ້ຄວາມຝັງດ້ວຍ `cid:`                 | ບໍ່ (ມັນຢູ່ໃນເນື້ອໃນ) |
| ຮູບພາບທີ່ຫມາຍວ່າ `Content-Disposition: inline`        | ບໍ່ (ມັນຢູ່ໃນເນື້ອໃນ) |
| ຮູບພາບທີ່ມີ `Content-ID` ແຕ່ເນື້ອໃນບໍ່ເຄີຍອ້າງອີງເຖິງ | ແມ່ນ                  |
| ອີເມວທີ່ແນບມາ (`message/rfc822`) ພ້ອມຊື່ໄຟລ໌          | ແມ່ນ                  |
| ໄຟລ໌ແນບທຳມະດາພ້ອມຊື່ໄຟລ໌                              | ແມ່ນ                  |

ຮູບພາບຈະຖືກນັບວ່າຖືກຝັງກໍ່ຕໍ່ເມື່ອຂໍ້ຄວາມຕົ້ນສະບັບອ້າງອີງເຖິງມັນແທ້ໆ, ຫຼືເມື່ອຜູ້ສົ່ງໄດ້ໝາຍມັນຢ່າງຈະແຈ້ງວ່າ `Content-Disposition: inline`. ພຽງແຕ່ຫົວຂໍ້ `Content-ID` ບໍ່ພຽງພໍ: ໂປຣແກຣມອີເມວບາງອັນໃສ່ມັນໄວ້ໃນທຸກສ່ວນຮູບພາບ, ລວມທັງໄຟລ໌ແນບແທ້ໆ, ແລະ ອັນເຫຼົ່ານັ້ນຍັງຕ້ອງຖືກສຳເນົາຢູ່.
...
- ຮູບພາບທີ່ຂໍ້ຄວາມຕົ້ນສະບັບຝັງໄວ້ຈະບໍ່ຖືກສຳເນົາເປັນໄຟລ໌. ພວກມັນຢູ່ໃນເນື້ອຫາການຕອບກັບແລ້ວ, ບ່ອນທີ່ Thunderbird ວາງໄວ້. ເບິ່ງ [ການຕັ້ງຄ່າ](configuration#include-inline-pictures).
