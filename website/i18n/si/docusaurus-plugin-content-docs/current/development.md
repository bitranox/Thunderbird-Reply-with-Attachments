...
- Node.js 22+ සහ npm (Node 22 සමඟ පරීක්ෂා කිරීම)
- Thunderbird 128 ESR හෝ නවතමය (අත්හාස පරීක්ෂා සඳහා)
...
- `sources/`: ප්‍රධාන අඩෝන කේතය (පසුබැසීම, විකල්ප/පොප්අප් UI, ගමන, ඔලි සංකේත)
- `tests/`: Vitest suite
- `website/`: Docusaurus docs (i18n සමඟ `website/i18n/de/...` යටතේ)
...
- Firefox Desktop හි කෙටි වටය (UI හුදෙක් පරීක්ෂා):
- `npx web-ext run --source-dir sources --target=firefox-desktop`
- Thunderbird හි ධාවනය කිරීම (MailExtensions සඳහා වාසීය):
- `npx web-ext run --source-dir sources --start-url about:addons --firefox-binary "$(command -v thunderbird || echo /path/to/thunderbird)"`
- උපදෙස්:
- Thunderbird නිවැරදි console එක විවෘත තබා ගන්න (Tools → Developer Tools → Error Console).
- MV3 සිදුකම් Idle වේද්ද හුදෙක් ප්‍රතිසෘජුම නිවේදන පද ගත කර; කේත සංශෝධන පසු අඩෝනය නැවත ආරම්භ කරන්න, නැත්නම් වෙබ් දුටුකිරීම් ස්වයංපෝෂණය කරන්න.
- Firefox හි යම් සංවිධාන වෙනස් වේ; API පරිපූරණය සඳහා හැම විටම Thunderbird හි සත්‍යතා පරීක්ෂා කරන්න.
- Thunderbird දත්ත ධාරාවන් (උදා:):
- Linux: `thunderbird` (උදා: `/usr/bin/thunderbird`)
- macOS: `/Applications/Thunderbird.app/Contents/MacOS/thunderbird`
- Windows: `"C:\\Program Files\\Mozilla Thunderbird\\thunderbird.exe"`
- ප්‍රොෆයිල් වෙන්දේසිය: දවසට යාවත්කාලීන කිරීම සඳහා වෙනස් වූ Thunderbird ප්‍රොෆයිල් එකක් භාවිතා කරන්න.
