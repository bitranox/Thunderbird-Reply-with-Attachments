...
- 2.0.0: Perrašymas į pilnavertę versiją (EN/DE)
- 1.0.1: Pereita prie messages.listAttachments()
...
- Išleidimai į ATN gali vėluoti kelias valandas po paketavimo.
- LOCAL kūrimo versijos skirtos tik kūrėjų testavimui ir neplatinamos per ATN.
