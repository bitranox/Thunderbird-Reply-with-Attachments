...
- கோப்புப் பெயரின் அடிப்படையில் நகல்கள் நீக்கப்படுகின்றன; S/MIME பகுதிகள் எப்போதும் தவிர்க்கப்படும். அசல் செய்தியில் பொதிக்கப்பட்ட படங்கள் பதிலின் உள்ளடக்கத்தில் அப்படியே இருக்கும், Thunderbird அவற்றை எங்கே வைக்கிறதோ அங்கே, மேலும் அவை கோப்புகளாக நகலெடுக்கப்படாது.
...
- பதிலைக் கண்டறி → அசல் இணைப்புகளை பட்டியலிடு → S/MIME மற்றும் உட்பொதிக்கப்பட்ட படங்களைத் தவிர்க்கவும் → விருப்ப உறுதிப்படுத்தல் → தகுதியான கோப்புகளைச் சேர் (நகல்களைத் தவிர்த்து).

| பகுதி வகை                                                    | பதிலில் நகலெடுக்கப்பட்டதா     |
|--------------------------------------------------------------|------------------------------:|
| S/MIME கையொப்பக் கோப்பு `smime.p7s`                          | இல்லை                         |
| S/MIME MIME வகைகள் (`application/pkcs7-*`)                   | இல்லை                         |
| செய்தி உள்ளடக்கம் `cid:` மூலம் பொதிக்கும் படம்               | இல்லை (உள்ளடக்கத்தில் உள்ளது) |
| `Content-Disposition: inline` எனக் குறிக்கப்பட்ட படம்        | இல்லை (உள்ளடக்கத்தில் உள்ளது) |
| உள்ளடக்கம் ஒருபோதும் குறிப்பிடாத `Content-ID` கொண்ட படம்     | ஆம்                           |
| கோப்புப் பெயருடன் இணைக்கப்பட்ட மின்னஞ்சல் (`message/rfc822`) | ஆம்                           |
| கோப்புப் பெயருடன் கூடிய வழக்கமான கோப்பு இணைப்பு              | ஆம்                           |

அசல் செய்தி உண்மையிலேயே ஒரு படத்தைக் குறிப்பிடும் போது, அல்லது அனுப்புநர் அதை
வெளிப்படையாக `Content-Disposition: inline` எனக் குறிக்கும் போது மட்டுமே அது
பொதிக்கப்பட்டதாகக் கருதப்படும். வெறும் `Content-ID` தலைப்பு மட்டும் போதாது: பல மின்னஞ்சல்
கிளையன்ட்கள் ஒவ்வொரு பட பகுதியிலும் அதை வைக்கின்றன, உண்மையான இணைப்புகள் உட்பட,
அவை இன்னும் நகலெடுக்கப்பட வேண்டும்.
...
- அசல் செய்தி உட்பொதிக்கும் படங்கள் கோப்புகளாக நகலெடுக்கப்படாது. அவை ஏற்கனவே Thunderbird வைத்த இடத்தில், பதில் உரையில் உள்ளன. [Configuration](configuration#include-inline-pictures)-ஐப் பார்க்கவும்.
