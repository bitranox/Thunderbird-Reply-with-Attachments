...
id: languages
title: 'Iilwimi'
sidebar_label: 'Iilwimi'
---

## Iilwimi

Le listi ibonisa uguqulelo lwezibhalo zewebhusayithi kunye nezichazi-magama ze-UI ezongezelelweyo.
Uxhaso lweelwimi ezinzulu, ngenxa yezixhobo zokuguqula AI — ezibandakanya iilwimi eziyi-100.

Uluhlu olungasentla luhlelwe ngohlobo lolwimi.

Jonga kunye: i [Glossary](glossary) yeenkcazo ezijolise kwiimveliso ze-UI ezisetyenziselwa kwiilwimi.

---

## Uluhlu lweelwimi {#language-list}
