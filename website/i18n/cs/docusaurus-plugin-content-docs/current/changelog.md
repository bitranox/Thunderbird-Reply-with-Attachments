...
- 2.0.0: přepis na plnohodnotnou verzi (EN/DE)
- 1.0.1: přešlo se na messages.listAttachments()
- 1.0.0: první vydání

---

## Termíny a kanály {#dates-and-channels}

- Vydání na ATN se mohou opozdit o několik hodin po zabalení.
- Sestavení LOCAL jsou určena pouze pro vývojářské testování a nejsou distribuována přes ATN.
