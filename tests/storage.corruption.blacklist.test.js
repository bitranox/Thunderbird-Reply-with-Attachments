...
describe('storage corruption: non-array blacklistPatterns', () => {
  it('treats non-array blacklistPatterns as empty and proceeds safely', async () => {
    ...
    browser.storage.local.get
      .mockResolvedValueOnce({ blacklistPatterns: 'oops', confirmBeforeAdd: false, confirmDefaultChoice: 'yes' })
      .mockResolvedValue({ blacklistPatterns: [], confirmBeforeAdd: false, confirmDefaultChoice: 'yes' });
